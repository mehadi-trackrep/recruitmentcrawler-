...
LANGUAGE_CODE =  'fi'
LOCATION_CODE = 'fi'
SITE_NAME = 'fi.indeed.com'
SITE_URL = 'https://fi.indeed.com/'

class IndeedFISpider(scrapy.Spider):
    name = "indeed_fi"
    ...
    # job_items_writer_file = open("indeed_se_job_items.json", "a")

    def __init__(self, tentative_jobs_count: int = 0, scraped_jobs_count: int = 0, name: str = None, **kwargs):
        super(IndeedFISpider, self).__init__(name, **kwargs)
    ...
    def start_requests(self):
        location_list = ['Helsinki', 'Tampere', 'Turku', 
                         'Oulu', 'Vantaa', 'Espoo',
